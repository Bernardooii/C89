...
export default class Profile extends Component {
  ...
  toggleSwitch() {
    ...
    var updates = {};
    updates[
      "/users/" + firebase.default.auth().currentUser.uid + "/current_theme"
    ] = theme;
    firebase.default
      .database()
      .ref()
        ...
        <View style={this.state.light_theme ? styles.containerlight : styles.container}>
          ...
          <View style={styles.appTitle}>
            ...
            <View style={styles.appTitleTextContainer}>
              <Text style={this.state.light_theme ? styles.appTitleTextlight : styles.appTitleText}>App de Posts</Text>
            </View>
          </View>
